export default function About() {
  return (
    <section className="relative bg-base-200 py-20 px-6 md:px-12 text-center overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-12">
          <div className="card bg-white shadow-lg p-6 hover:shadow-xl transition-transform duration-300 hover:-translate-y-1">
